...
const experienceList: ItemProps[] = [
  {
    ...
    • Architect Oak+Fort e-commerce website: building catalog, processing payment, ... 
    for supporting online customers' shopping across the United States and Canada
    `,
  ...
  },
  {
    ...
    • Managed team performance by training, mentoring, disciplining, and
    motivating employees
    • Architect CleanOver Platform for supporting 20 cleaners and managers in
    rental vacation management with more than 150 vacation properties
    `,
  ...
  },
  {
    ...
    description: `
    • Architect Revere Platform to support more than 300.000 property listings
    from across entire Canada
    • Lead Production team to revamp platform UI
    • Lead AI team to work on Home Prediction model for House Evaluation
    Coordinate both teams to deliver Posting Pipeline to allow users to post
    listings on the platform
    • Complete the integration process for AI model into Posting Pipeline and
    Home Evaluation tool
    • Mentor 2 junior full-stack engineers
    • Work with product owner and team to deliver features on time
    `,
  ...
  },
  {
    ...
    company: 'Oak + Fort',
    description: `
    •Build backend for Revere Platform using GraphQL, Firebase and Cloud
    functions
    • Collaborated with front-end developers to deliver features
    `,
    companyLink: 'https://revere-tech.com/',
  },
];
